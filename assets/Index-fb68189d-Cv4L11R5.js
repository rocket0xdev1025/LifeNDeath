...
import { merge as et } from "./index-C4SOl0hr.js";
import { s as nt, d as tt } from "./index-D_XAAfb4.js";
var Pn =
  ...
  return {
    c() {
      ...
      p(
        ...
        "class",
        (i =
          Le(`flex justify-center items-center pointer ${e[4]}`) +
          " svelte-1uqued6")
      ),
        p(
          n,
    ...
    m(b, m) {
      M(b, n, m), v && v.m(n, null), c(n, o);
      for (let d = 0; d < l.length; d += 1) l[d] && l[d].m(n, null);
      Ze(n, e[6].chains[0].id),
        e[13](n),
        f || ((u = J(n, "change", e[10])), (f = !0));
    },
    p(b, m) {
      m & 68 && (t = !Oe(b[6].chains[0], b[2])),
        t
          ? v
            ? v.p(b, m)
            : ((v = Je(b)), v.c(), v.m(n, o))
          : v && (v.d(1), (v = null)),
        m & 4 &&
          ((k = b[2]), (l = zn(l, m, h, 1, b, k, r, n, Kn, Ke, null, Ue))),
        m & 16 &&
          i !==
            (i =
              Le(`flex justify-center items-center pointer ${b[4]}`) +
              " svelte-1uqued6") &&
          p(n, "class", i),
        m & 64 && s !== (s = b[6].chains[0].id) && Ze(n, b[6].chains[0].id),
        m & 11 &&
          a !==
            (a = `
        color: var(${b[1]},
...
function rt(e) {
  ...
  return {
    c() {
      (n = g("span")),
        ...
        p(
          n,
          "class",
          (o = Le(`switching-placeholder ${e[4]}`) + " svelte-1uqued6")
        ),
        p(
          n,
          "style",
    ...
    p(r, i) {
      i & 16 &&
        o !== (o = Le(`switching-placeholder ${r[4]}`) + " svelte-1uqued6") &&
        p(n, "class", o),
        i & 2 &&
          l !==
            (l = `
...
function it(e, n, t) {
  ...
  ee(e, k, (w) => t(7, (i = w)));
  let h;
  const b = et(Me, k.pipe(nt(1))).pipe(
    tt(50),
    Gn((w, C) =>
  ...
  async function m() {
    ...
    w !== o.chains[0].id &&
      (k.next(!0),
      await Rn({ chainId: w, chainNamespace: "evm", wallet: o.label }),
      k.next(!1));
  }
  function d() {
    if (!h) return;
    ...
    p(C, $) {
      (e = C),
        ...
        $ & 20 &&
          ...
          V(f, a),
        $ & 4 && k !== (k = e[2].accountCenter.copyAddress + "") && V(h, k);
    },
    i(C) {
      C &&
        (b ||
...
function nn(e) {
  ...
  return {
    ...
    m(s, a) {
      M(s, n, a), c(n, o), l || ((r = J(n, "click", fe(i))), (l = !0));
    },
    p(s, a) {
      (e = s),
        a & 20 &&
...
function tn(e) {
  let n,
    ...
    s,
    a,
    f = (e[15] ? de(e[15].name) : e[16] ? de(e[16].name) : Ve(e[14])) + "",
    u,
    v,
    k,
    h,
  ...
  return {
    c() {
      (n = g("div")),
        ...
        ce(h, "active", e[3] === e[14]),
        p(t, "class", "container svelte-hb2n95"),
        ce(t, "primary", e[1] && e[19] === 0),
        p(n, "class", "relative");
    },
    m(j, W) {
      M(j, n, W),
        ...
        c(n, d),
        (_ = !0),
        w || ((C = [J(b, "click", fe(B)), J(t, "click", D)]), (w = !0));
    },
    p(j, W) {
      e = j;
      const U = {};
      W & 2 &&
        ...
        (!_ || W & 1) &&
          f !==
            (f =
              (e[15] ? de(e[15].name) : e[16] ? de(e[16].name) : Ve(e[14])) +
              "") &&
          V(u, f),
        e[17]
          ? P
            ? (P.p(e, W), W & 1 && y(P, 1))
            : ((P = xe(e)), P.c(), y(P, 1), P.m(s, null))
          : P && (P.d(1), (P = null)),
        (!_ || W & 9) && ce(h, "active", e[3] === e[14]),
        (!_ || W & 2) && ce(t, "primary", e[1] && e[19] === 0),
        e[3] === e[14]
          ? I
            ? (I.p(e, W), W & 9 && y(I, 1))
            : ((I = en(e)), I.c(), y(I, 1), I.m(n, d))
          : I && (I.d(1), (I = null));
    },
    i(j) {
      _ || (y(l.$$.fragment, j), y($), y(P), y(I), (_ = !0));
    },
    o(j) {
      T(l.$$.fragment, j), T($), (_ = !1);
    },
    d(j) {
      j && S(n), Z(l), $ && $.d(), P && P.d(), I && I.d(), (w = !1), ke(C);
    },
  };
}
function dt(e) {
    ...
    p(i, [s]) {
      if (s & 127) {
        ...
        for (a = 0; a < o.length; a += 1) {
          ...
          l[a]
            ? (l[a].p(f, s), y(l[a], 1))
            : ((l[a] = tn(f)), l[a].c(), y(l[a], 1), l[a].m(n.parentNode, n));
        }
  ...
  async function a(d) {
    try {
      ...
      (w === Fe.UNSUPPORTED_METHOD || w === Fe.DOES_NOT_EXIST) &&
        Xn.next({ inProgress: !1, actionRequired: d.label });
    }
  }
  function f() {
    t(2, (L.accountCenter.copyAddress = "Copied Successfully"), L),
      setTimeout(i, 500),
      setTimeout(() => {
...
class ft extends pe {
  constructor(n) {
    super(),
      ve(this, n, ut, dt, me, { wallet: 0, primary: 1, hideMenu: 7 }, ct);
  }
  get hideMenu() {
    return this.$$.ctx[7];
  }
...
`,
  ...
  qn = `<svg width="14" height="18" viewBox="0 0 14 18" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function ht(e) {
  ...
  return (
    (n = new Sn({
      props: { close: e[1], $$slots: { default: [bt] }, $$scope: { ctx: e } },
    })),
    {
      c() {
        E(n.$$.fragment);
...
class wt extends pe {
  constructor(n) {
    super(), ve(this, n, _t, ht, me, { onConfirm: 0, onClose: 1 }, gt);
  }
}
function kt(e) {
  ge(
  ...
  return {
    c() {
      (n = g("div")),
        ...
        p(B, "class", "button-neutral-solid rounded primary svelte-ruodf3"),
...
function Ct(e) {
  ...
  return (
    (n = new Sn({
      props: { close: e[1], $$slots: { default: [yt] }, $$scope: { ctx: e } },
    })),
    {
      c() {
        E(n.$$.fragment);
...
class $t extends pe {
  constructor(n) {
    super(),
      ve(this, n, zt, Ct, me, { onEnable: 0, onDismiss: 1, infoLink: 2 }, kt);
  }
}
function Tt(e) {
  ge(
  ...
  return {
    ...
    p(m, d) {
      h === (h = k(m)) && b
        ...
        d & 1 && r !== (r = m[1].name.toUpperCase() + "") && V(i, r),
        d & 1 &&
          f !==
            (f =
  ...
  return (
    Ge((t = e[1].icon), o),
    {
      ...
      p(l, r) {
        (e = l),
          (o.ctx = e),
          (r & 1 && t !== (t = e[1].icon) && Ge(t, o)) || Qn(o, e, r);
      },
      d(l) {
...
function an(e) {
  let n,
    t = e[1] && e[1].name && e[1].balance && rn(e);
  return {
    c() {
      t && t.c(), (n = ue());
    },
...
function Ht(e) {
  ...
  return {
    ...
    m(a, f) {
      M(a, n, f), c(n, t), c(t, o), c(t, l), c(t, r);
...
class It extends pe {
  constructor(n) {
    super(), ve(this, n, Vt, Ht, me, { secondaryTokens: 0 }, Tt);
  }
}
function Bt(e) {
  ge(
...
function cn(e) {
  let n, t;
  return (
    (n = new wt({ props: { onClose: e[22], onConfirm: e[13] } })),
    {
      c() {
        E(n.$$.fragment);
      },
    ...
    })),
    {
      ...
      p(o, l) {
        ...
        l[0] & 16 && (r.onDismiss = o[23]),
          l[0] & 512 && (r.infoLink = o[9].transactionProtectionInfoLink || Be),
          n.$set(r);
      },
      i(o) {
        t || (y(n.$$.fragment, o), (t = !0));
  ...
  return {
    c() {
      ...
      (s = z()),
        ...
        ce(u, "background-blue", (e[5] && e[5].icon) || e[7]),
        ce(u, "background-yellow", !e[5]),
        ce(u, "background-gray", e[5] && !e[7]),
        p(Y, "href", "https://thirdweb.com"),
        p(Y, "target", "_blank"),
    ...
    p(F, H) {
      (e = F),
        H[0] & 10 &&
          ((x = e[1]),
          ae(),
          (r = zn(r, H, Ae, 1, e, x, i, l, In, fn, null, sn)),
          ie()),
        e[17].type === "desktop" && se.p(e, H);
      const re = {};
      H[0] & 32 &&
        (re.color = e[5] ? (e[5].icon ? void 0 : "#EFF1FC") : "#FFAF00"),
        H[0] & 160 &&
          (re.customBackgroundColor = e[5]
            ? e[5].color || (e[7] && e[7].color) || be.color
            : "#FFE7B3"),
        H[0] & 160 &&
          (re.icon = e[5] ? e[5].icon || (e[7] && e[7].icon) || be.icon : Se),
        h.$set(re),
        e[5]
          ? R
            ? H[0] & 32 && y(R, 1)
            : ((R = pn()), R.c(), y(R, 1), R.m(k, null))
          : R &&
            (ae(),
            T(R, 1, 1, () => {
              R = null;
        ...
        (e[6] || (e[5] && e[5].protectedRpcUrl))
          ? le
            ? le.p(e, H)
            : ((le = vn(e)), le.c(), le.m(u, null))
          : le && (le.d(1), (le = null)),
        (!oe || H[0] & 160) &&
          ce(u, "background-blue", (e[5] && e[5].icon) || e[7]),
        (!oe || H[0] & 32) && ce(u, "background-yellow", !e[5]),
        (!oe || H[0] & 160) && ce(u, "background-gray", e[5] && !e[7]),
        e[11]
          ? K
            ? (K.p(e, H), H[0] & 2048 && y(K, 1))
            : ((K = mn(e)), K.c(), y(K, 1), K.m(j, W))
          : K &&
            (ae(),
            T(K, 1, 1, () => {
              K = null;
        ...
        e[8] && e[8].length
          ? Q
            ? (Q.p(e, H), H[0] & 256 && y(Q, 1))
            : ((Q = _n(e)), Q.c(), y(Q, 1), Q.m(j, U))
          : Q &&
            (ae(),
            T(Q, 1, 1, () => {
              Q = null;
...
function fn(e, n) {
  ...
  return (
    ...
    (o = new ft({ props: s })),
    $n.push(() => Bn(o, "hideMenu", i)),
    {
      key: e,
      first: null,
      c() {
        (t = ue()), E(o.$$.fragment), (this.first = t);
      },
      m(a, f) {
        M(a, t, f), O(o, a, f), (r = !0);
      },
      p(a, f) {
        ...
        f[0] & 2 && (u.wallet = n[29]),
          ...
          !l && f[0] & 8 && ((l = !0), (u.hideMenu = n[3]), Dn(() => (l = !1))),
          o.$set(u);
      },
      i(a) {
...
function gn(e) {
  let n,
    t,
    o =
      e[10]("accountCenter.appInfo", { default: L.accountCenter.appInfo }) + "",
    l,
    r,
    i,
    s = e[11].gettingStartedGuide && bn(e),
    a = e[11].explore && hn(e);
  return {
    c() {
      (n = g("div")),
...
function bn(e) {
  let n,
    t,
    o =
      e[10]("accountCenter.learnMore", { default: L.accountCenter.learnMore }) +
      "",
    l,
    r,
    i,
  ...
  return {
    ...
    m(u, v) {
      M(u, n, v), c(n, t), c(t, l), c(n, r), c(n, i), c(i, a);
    },
    p(u, v) {
      v[0] & 1024 &&
        o !==
...
function hn(e) {
  let n,
    ...
    i,
    s =
      e[10]("accountCenter.explore", { default: L.accountCenter.explore }) + "",
    a,
    f;
  return {
    c() {
...
function _n(e) {
  let n, t;
  return (
    (n = new It({ props: { secondaryTokens: e[8] } })),
    {
      c() {
        E(n.$$.fragment);
      },
  ...
  return {
    ...
    p(a, f) {
      a[2]
        ? r
          ? (r.p(a, f), f[0] & 4 && y(r, 1))
          : ((r = cn(a)), r.c(), y(r, 1), r.m(n.parentNode, n))
        : r &&
          (ae(),
          T(r, 1, 1, () => {
            r = null;
        ...
        a[4]
          ? i
            ...
            : ((i = dn(a)), i.c(), y(i, 1), i.m(t.parentNode, t))
          : i &&
            (ae(),
            T(i, 1, 1, () => {
              i = null;
        ...
        a[0]
          ? s
            ? (s.p(a, f), f[0] & 1 && y(s, 1))
            : ((s = un(a)), s.c(), y(s, 1), s.m(o.parentNode, o))
          : s &&
            (ae(),
            T(s, 1, 1, () => {
              s = null;
...
function Nt(e, n, t) {
  ...
  ee(e, $, (A) => t(11, (k = A)));
  const { position: P } = ne.get().accountCenter,
    { device: B } = Wn,
    D = async () => {
      if (i)
        try {
          await Nn(o.provider, i, i.protectedRpcUrl || Fn), t(4, (C = !1));
        } catch (A) {
          const { code: N } = A;
          console.log(A, N);
        }
    ...
    (e.$$.update = () => {
      e.$$.dirty[0] & 2 && t(19, ([o] = f), o),
        ...
        e.$$.dirty[0] & 1048576 &&
          t(
            5,
            (i = d.find(({ id: A, namespace: N }) =>
              l ? A === l.id && N === l.namespace : !1
            ))
          ),
        e.$$.dirty[0] & 1048576 && t(7, (s = Cn(l && l.id))),
...
class jn extends pe {
  constructor(n) {
    super(), ve(this, n, Nt, Wt, me, { expanded: 0 }, Bt, [-1, -1]);
  }
}
function Ft(e) {
  ge(
    ...
    })),
    {
      c() {
        (n = g("div")),
          ...
          p(B, "class", "chain-icon-container svelte-1xsvwqj"),
          p(P, "class", "flex items-center"),
      ...
      p(N, [x]) {
        ...
        const se = {};
        x & 2 && (se.icon = e[1] ? e[1].icon : ""),
          a.$set(se),
          (!Y || x & 448) &&
            m !== (m = (e[8] ? de(e[8]) : e[7] ? de(e[7]) : e[6]) + "") &&
            V(d, m),
          e[5]
            ? A
              ? (A.p(e, x), x & 32 && y(A, 1))
              : ((A = wn(e)), A.c(), y(A, 1), A.m(h, null))
            : A && (A.d(1), (A = null));
        const R = {};
        x & 16 &&
          (R.color = e[4]
          ...
          x & 24 &&
            (R.customBackgroundColor = e[4]
              ...
              : "var(--onboard-warning-200, var(--warning-200))"),
          x & 24 &&
            (R.icon = e[4] ? e[4].icon || (e[3] && e[3].icon) || be.icon : Se),
          D.$set(R),
          (!Y ||
            (x & 16 &&
              W !==
      ...
      i(N) {
        Y ||
          ...
          N &&
            Te(() => {
              Y &&
                (X && X.end(1), (U = Pe(n, $e, { duration: 250 })), U.start());
            }),
          (Y = !0));
      },
      o(N) {
  ...
  return (
    ...
    (e.$$.update = () => {
      e.$$.dirty & 16384 && t(1, ([o] = h), o),
        ...
        e.$$.dirty & 8192 && t(8, (r = l && l.ens && de(l.ens.name))),
        e.$$.dirty & 8192 && t(7, (i = l && l.uns && de(l.uns.name))),
        e.$$.dirty & 8192 && t(6, (s = l ? Ve(l.address) : "")),
        e.$$.dirty & 8192 &&
...
class Zt extends pe {
  constructor(n) {
    super(), ve(this, n, Ot, Et, me, { toggle: 0 }, Ft);
  }
}
function Gt(e) {
  ge(
...
class Xt extends pe {
  constructor(n) {
    super(), ve(this, n, Ut, Rt, me, { toggle: 0 }, Gt);
  }
}
function Jt(e) {
  ge(
...
function xt(e, n, t) {
  ...
  function i() {
    o.expanded && (Ie({ expanded: !1 }), t(0, (l = !1)));
  }
  function s() {
    Ie({ expanded: !o.expanded }), t(0, (l = !l));
  }
  return [l, o, r, i, s];
}
class oo extends pe {
