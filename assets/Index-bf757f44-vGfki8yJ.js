  ...
  return {
    ...
    css: (u, b) => {
      const p = b * s,
        ...
        j = u + (b * e.height) / t.height;
      return `transform: ${a} translate(${p}px, ${y}px) scale(${z}, ${j});`;
    },
  };
}
function Ge(i) {
    ...
    c() {
      (e = h("div")),
        ...
        m(
          n,
          "style",
          (l = `background:${L[i[1].type].backgroundColor}; color: ${
            L[i[1].type].iconColor || ""
          }; ${
            i[1].type === "pending"
              ? "height: 28px; width: 28px; margin: 2px;"
              : `border: 2px solid ${L[i[1].type].borderColor}`
          }; `)
        ),
        m(e, "class", "relative");
    },
    ...
    p(u, b) {
      u[1].type === "pending"
        ...
        (!c ||
          (b & 2 &&
            l !==
              (l = `background:${L[u[1].type].backgroundColor}; color: ${
                L[u[1].type].iconColor || ""
              }; ${
                u[1].type === "pending"
                  ? "height: 28px; width: 28px; margin: 2px;"
                  : `border: 2px solid ${L[u[1].type].borderColor}`
              }; `))) &&
          m(n, "style", l),
        b & 2 &&
          (r =
  ...
  return {
    ...
    p(o, [a]) {
      o[1].type
        ? n
          ? (n.p(o, a), a & 2 && w(n, 1))
          : ((n = ne(o)), n.c(), w(n, 1), n.m(e.parentNode, e))
        : n &&
          (G(),
          T(n, 1, 1, () => {
            n = null;
...
function Ke(i, e, t) {
  let { chainStyles: n = Fe } = e,
    { notification: o } = e;
  return (
    (i.$$set = (a) => {
      "chainStyles" in a && t(0, (n = a.chainStyles)),
...
function tt(i) {
  ...
  return {
    ...
    p(a, f) {
      f & 1 && t !== (t = q(a[0].id) + "") && K(n, t),
        f & 1 && o !== (o = a[0].link) && m(e, "href", o);
    },
    d(a) {
      a && C(e);
    },
...
function nt(i) {
  ...
  return {
    ...
    p(r, [c]) {
      (!l || c & 1) && n !== (n = r[0].message + "") && K(o, n),
        c & 1 &&
          (f =
            r[0].id &&
            !r[0].id.includes("customNotification") &&
            !r[0].id.includes("preflight")),
        f
          ? s
            ? (s.p(r, c), c & 1 && w(s, 1))
...
async function fe({ type: i, wallet: e, transaction: t }) {
  const {
    ...
    c = W[r],
    { gasPriceProbability: d } = Y.get().notify.replacement,
    { gas: v } = Z;
  if (!v) return;
  const [u] = await v.get({ chains: [W[r]], endpoint: "blockPrices" }),
    { maxFeePerGas: b, maxPriorityFeePerGas: p } =
  ...
  return {
    ...
    m(l, s) {
      _(l, e, s),
        ...
        g(e, n),
        g(e, o),
        a || ((f = [S(t, "click", i[10]), S(o, "click", i[11])]), (a = !0));
    },
    p: I,
    d(l) {
      l && C(e), (a = !1), he(f);
...
function ft(i) {
  ...
  (n = new Ye({
    props: { notification: i[0], chainStyles: J[W[i[0].network]] },
  })),
    (a = new ot({ props: { notification: i[0] } }));
  ...
  return {
    c() {
      (e = h("div")),
        ...
        V(
          c,
          "dropdown-visible",
          i[2] && i[5] && le(i[0].eventCode) && se(i[0].network) && ce(i[7])
        ),
        m(
          e,
          "class",
        ...
        V(e, "bn-notify-clickable", i[0].onClick);
    },
    m(y, z) {
      _(y, e, z),
        g(e, t),
    ...
    p(y, [z]) {
      const j = {};
      z & 1 && (j.notification = y[0]),
        z & 1 && (j.chainStyles = J[W[y[0].network]]),
        n.$set(j);
      const k = {};
      z & 1 && (k.notification = y[0]),
        ...
        y[0].eventCode === "txPool"
          ? p
            ? p.p(y, z)
            : ((p = de(y)), p.c(), p.m(c, null))
          : p && (p.d(1), (p = null)),
        (!v || z & 165) &&
          V(
            c,
            "dropdown-visible",
            y[2] && y[5] && le(y[0].eventCode) && se(y[0].network) && ce(y[7])
          ),
        (!v ||
          (z & 1 &&
            d !==
              (d =
                ...
                "} svelte-ftkynd"))) &&
          m(e, "class", d),
        (!v || z & 1) && V(e, "bn-notify-clickable", y[0].onClick);
    },
    i(y) {
      v || (w(n.$$.fragment, y), w(a.$$.fragment, y), (v = !0));
    },
    o(y) {
      T(n.$$.fragment, y), T(a.$$.fragment, y), (v = !1);
    },
    d(y) {
      y && C(e), $(n), $(a), p && p.d(), (u = !1), he(b);
    },
  };
}
function dt(i, e, t) {
  let n, o;
  D(i, Me, (k) => t(15, (n = k))), D(i, ge, (k) => t(3, (o = k)));
  const { device: a, gas: f } = Z;
  let { notification: l } = e,
    { updateParentOnRemove: s } = e,
    r,
    c = !1;
  const d = Oe.getValue().find(({ hash: k }) => k === l.id),
    v =
      d &&
      n.find(
        ({ accounts: k }) =>
          !!k.find(({ address: P }) => P.toLowerCase() === d.from.toLowerCase())
      );
  function u(k) {
  ...
  return (
    ...
    [l, s, c, o, a, f, d, v, u, b, p, y, z, j]
  );
}
class ut extends R {
  constructor(e) {
    super(),
      N(this, e, dt, ft, M, { notification: 0, updateParentOnRemove: 1 }, ct);
  }
}
function vt(i) {
  O(
...
function ve(i) {
  ...
  return {
    ...
    p(r, c) {
      ...
      (!f ||
        (c & 33 &&
          o !== (o = "bn-notify-" + r[0] + " " + r[5] + " svelte-1h8mmo3"))) &&
        m(e, "class", o),
        (!f ||
          (c & 67 &&
            a !==
              (a = `${
                r[0].includes("top") ? "justify-content:flex-start;" : ""
              }; max-height: calc(100vh - ${
                r[6].expanded
                  ? "412px"
                  : r[1] && r[7].type !== "mobile"
  ...
  return (
    ...
    })),
    {
      ...
      o(u) {
        T(n.$$.fragment, u),
          f && f.invalidate(),
          (l = Se(t, Re, { duration: 300, easing: be })),
          (c = !1);
      },
      d(u) {
        u && C(t), $(n), u && l && l.end(), (d = !1), v();
      },
    }
  );
}
  ...
  return {
    ...
    p(o, [a]) {
      o[2].length
        ? n
          ? (n.p(o, a), a & 4 && w(n, 1))
          : ((n = ve(o)), n.c(), w(n, 1), n.m(e.parentNode, e))
        : n &&
          (G(),
          T(n, 1, 1, () => {
            n = null;
